...
public class NerdLauncherFragment extends Fragment{
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent i = new Intent(Intent.ACTION_MAIN).setClassName(activityInfo.packageName, activityInfo.name )
    ...
    private class ActivityAdapter extends RecyclerView.Adapter<ActivityHolder> {
        ...
        @Override
        public ActivityHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        public void onBindViewHolder(ActivityHolder activityHolder, int i) {
            ResolveInfo ri = mActivities.get(i);
            activityHolder.bindActivity(ri);
        }
